...
//const TString FFiso = "medium";
const TString FFversion="fakeFactors_20170515_"+FFiso+".root";
...
//const vector<TString> variables={s_mttot,s_pt1,s_pt2,s_mvis,s_met}; //s_mvis,s_met,s_pt1,s_pt2
//const vector<TString> categories={s_nobtag_tight,s_nobtag_loosemt,s_btag_tight,s_btag_loosemt};
